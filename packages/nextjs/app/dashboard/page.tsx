...
const Dashboard = () => {
  ...
  const {
    ...
    address: activeTokenMainAccount as `0x${string}`,
  });
  ...
  const { writeContractAsync: createNewAccount } = useScaffoldWriteContract("ERC6551Registry");
            ...
            <div className="grid gap-2 items-center justify-between grid-flow-col">
              ...
              <div>
                ...
                {activeTokenMainAccount && !isLoading ? (
                  <Address address={activeTokenMainAccount as `0x${string}`} size="sm" />
                ) : (
